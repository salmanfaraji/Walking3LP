...
r.hand =      [1e-3  0.5  0.1028];
r.forearm =   [1e-3  0.5  0.1531];
r.upperarm =  [1e-3  0.5  0.1600];
r.foot =      [1e-3  0.5  0.1470, 0.0451];
r.shank =     [1e-3  0.5  0.4165, 0.2522];
r.thigh =     [0.05  1e-1 0.4033, 0.2269];
r.trunk =     [0.9  1-1e-3 0.4630, 0.3495];
r.head =      [1e-3  0.5  0.4555, 0.1396];
r.pelvis = 0.0636;
